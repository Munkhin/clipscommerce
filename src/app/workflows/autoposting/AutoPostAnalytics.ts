...
export class AutoPostAnalytics {
  ...
  generateReport(periodDays = 7) {
    ...
    const totalEngagement = filtered.reduce((a, b) => a + (b.engagement.likes + b.engagement.comments + b.engagement.shares + (b.engagement.saves || 0) + (b.engagement.clicks || 0)), 0);
    const totalReach = filtered.reduce((a, b) => a + (b.reach.impressions + b.reach.uniqueViews + b.reach.organicReach + (b.reach.paidReach || 0)), 0);
