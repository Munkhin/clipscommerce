...
function parseArguments(): CollectionOptions {
  ...
  // Validate platforms
  const validPlatforms: Platform[] = [PlatformEnum.INSTAGRAM, PlatformEnum.TIKTOK, PlatformEnum.YOUTUBE];
...
async function main() {
  ...
  try {
    ...
    if (options.outputReport) {
      ...
      await generateDetailedReport(result, options, reportPath, durationMs);
